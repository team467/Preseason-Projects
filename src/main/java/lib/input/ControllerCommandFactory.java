...
public class ControllerCommandFactory {
    ...
    public static byte[] setAllLEDEffect(int effect) {
        return new byte[]{ControllerDataProtocol.CommandID.SetLed,
                ControllerDataProtocol.LightingSelection.All, ControllerDataProtocol.LightingValue.LedEffect,
                (byte) effect};
    }
    ...
    public static byte[] setAllLEDOffset(int offset) {
        return new byte[]{ControllerDataProtocol.CommandID.SetLed,
                ControllerDataProtocol.LightingSelection.All, ControllerDataProtocol.LightingValue.LedOffset,
                (byte) offset};
    }
